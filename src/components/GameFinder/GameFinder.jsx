    ...
    return (
        <div className='game-finder'>
            {!gameInfo || !gameInfo.title ? (
                <button onClick={search} className="game-finder__randomizer" type="button">Click to Search</button>
            ) : (
            <>
                ...
                <button onClick={search} className="game-finder__randomizer" type="button">Pick another game</button>
            </>    
            )}
        </div>
    )
